...
results = {
  ...
  'dwayne_johnson': {'face_1': [False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False]},
  ...
  'will_smith': {'face_1': [True, False, False, False, True, True, False, True, False, False, False, False, True, False, False, True, False, False, False, False, True]},
...
taux = (results['will_smith']['face_1'].count(True)/len(results['will_smith']['face_1']))*100
print(results['will_smith']['face_1'].count(False))